...
exports.updateDockerComposeProperties = void 0;
const updateDockerComposeProperties = (settings) => {
...
exports.updateDockerComposeProperties = updateDockerComposeProperties;
...
module.exports = /*#__PURE__*/JSON.parse('{"settings":{"host":"localhost","port":5432,"user":"admin","password":"admin","dbName":"postgres"}}');
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"@amplication/plugin-dotnet-db-postgres","version":"0.0.3","description":"Use a PostgreSQL database in a service generated by Amplication","main":"dist/index.js","nx":{},"scripts":{"dev":"webpack --watch","build":"webpack","prebuild":"rimraf dist"},"author":"Daniele Iasella","license":"Apache-2.0","devDependencies":{"@amplication/csharp-ast":"^0.0.3","@amplication/code-gen-types":"2.0.34","@amplication/code-gen-utils":"^0.0.9","@babel/parser":"^7.18.11","@babel/types":"^7.18.10","@types/lodash":"^4.14.182","@types/normalize-path":"^3.0.0","@typescript-eslint/eslint-plugin":"^5.33.0","@typescript-eslint/parser":"^5.33.0","copy-webpack-plugin":"^12.0.2","eslint":"^8.21.0","jest-mock-extended":"^2.0.7","lodash":"^4.17.21","pascal-case":"^3.1.2","prettier":"^2.6.2","rimraf":"^4.4.1","ts-loader":"^9.4.2","typescript":"^4.9.3","webpack":"^5.75.0","webpack-cli":"^5.0.1"}}');
...
const pascal_case_1 = __webpack_require__(697);
...
class PostgreSQLPlugin {
    ...
    beforeCreateServerDockerCompose(context, eventParams) {
        const settings = (0, utils_1.getPluginSettings)(context.pluginInstallations);
        eventParams.updateProperties.push(...(0, constants_1.updateDockerComposeProperties)(settings));
        return eventParams;
    }
    beforeCreateServerCsproj(_, eventParams) {
    ...
    beforeCreateServerAppsettings(context, eventParams) {
        const { port, password, user, host, dbName } = (0, utils_1.getPluginSettings)(context.pluginInstallations);
    ...
    beforeCreateProgramFile({ resourceInfo }, eventParams) {
        const serviceNamespace = (0, pascal_case_1.pascalCase)(resourceInfo?.name ?? "");
        const serviceDbContext = `${(0, pascal_case_1.pascalCase)(resourceInfo?.name ?? "")}DbContext`;
        eventParams.builderServicesBlocks.push(new csharp_ast_1.CodeBlock({
            ...
            references: [
                new csharp_ast_1.ClassReference({
                    name: "AddDbContext",
...
exports["default"] = PostgreSQLPlugin;
